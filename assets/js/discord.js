document.addEventListener('DOMContentLoaded', () => {
    const userId = "1360118127429419159"; // Replace with your hardcoded user ID
    const apiUrl = `https://discord-lookup-api-alpha.vercel.app/v1/user/$1360118127429419159`;
